...
public class Nivel2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Al pasar al nivel 2, mostrar la puntuación que se tenía
        puntuacionSt = getIntent().getStringExtra("puntuacion");
        puntuacion = Integer.parseInt(puntuacionSt);
        //tvPuntuacion.setText("Puntuación: " + puntuacion);
        tvPuntuacion.setText(puntuacion + " pts");

        // Al pasar al nivel 2, mostrar las vidas que se tenían
        vidasSt = getIntent().getStringExtra("vidas");
        vidas = Integer.parseInt(vidasSt);
        if (vidas == 3) {
